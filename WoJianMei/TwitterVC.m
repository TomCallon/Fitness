...
@synthesize demoWorkOutImage =_demoWorkOutImage;
@synthesize demoWorkOutMethods =_demoWorkOutMethods;
...
- (void)dealloc {
    ...
    [theTextView release];
    [TVBackView release];
    [_demoWorkOutImage release];
    [_demoWorkOutMethods release];
    [super dealloc];
}
